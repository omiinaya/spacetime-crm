...
mod tests {
    ...
    fn test_set_default_payment_method() {
        ...
        let second = methods
            .iter()
            .find(|m| m.last4 == "2222")
            .expect("expected payment method with last4 2222");
        ...
        let first = updated_methods
            .iter()
            .find(|m| m.last4 == "1111")
            .expect("expected payment method with last4 1111");
        let second2 = updated_methods
            .iter()
            .find(|m| m.last4 == "2222")
            .expect("expected payment method with last4 2222");
    ...
    fn test_delete_payment_method() {
        ...
        let id = ctx
            ...
            .iter()
            .next()
            .expect("expected at least one saved_payment_methods record")
            .id
            .clone();
