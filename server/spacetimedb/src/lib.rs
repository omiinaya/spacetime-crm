...
#[spacetimedb::reducer]
pub fn create_invoice(ctx: &ReducerContext, tenant_id: String, customer_id: String, ticket_id: String, notes: String, terms: String, due_date: u64, currency: String, discount_percent: f64, discount_amount: f64) {
