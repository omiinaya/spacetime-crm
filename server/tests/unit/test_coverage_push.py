...
def test_invoices_full(client, auth_headers, configure_stdb):
    ...
    client.get("/api/invoices/summary", headers=h)
    client.get("/api/invoices/overdue-count", headers=h)
    client.get("/api/invoices/i1", headers=h)
    client.get("/api/invoices/i1/line-items", headers=h)
    client.get("/api/invoices/i1/pdf", headers=h)
...
def test_portal_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "p1"}])
    h = auth_headers
    client.get("/api/portal/me", headers=h)
    client.get("/api/portal/stats", headers=h)
    client.get("/api/portal/tickets", headers=h)
    client.get("/api/portal/tickets/t1", headers=h)
    client.get("/api/portal/invoices", headers=h)
    client.get("/api/portal/invoices/i1", headers=h)
...
def test_tickets_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "t1", "subject": "S"}])
    h = auth_headers
    client.get("/api/tickets", headers=h)
    client.get("/api/tickets/t1", headers=h)
...
def test_tenants_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "t1", "name": "T"}])
    h = auth_headers
    client.get("/api/tenants", headers=h)
    client.get("/api/tenants/t1", headers=h)
...
def test_products_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "p1"}])
    h = auth_headers
    client.get("/api/products", headers=h)
    client.get("/api/products/p1", headers=h)
...
def test_estimates_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "e1"}])
    h = auth_headers
    client.get("/api/estimates", headers=h)
    client.get("/api/estimates/e1", headers=h)
...
def test_appointments_full(client, auth_headers, configure_stdb):
    ...
    client.get("/api/appointments/a1", headers=h)
...
def test_payments_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "p1"}])
    h = auth_headers
    client.get("/api/payments", headers=h)
    client.get("/api/payments/p1", headers=h)
...
def test_purchase_orders_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "po1"}])
    h = auth_headers
    client.get("/api/purchase-orders", headers=h)
    client.get("/api/purchase-orders/po1", headers=h)
...
def test_recurring_invoices_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "ri1"}])
    h = auth_headers
    client.get("/api/recurring-invoices", headers=h)
    client.get("/api/recurring-invoices/ri1", headers=h)
...
def test_webhooks_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "w1"}])
    h = auth_headers
    client.get("/api/webhooks", headers=h)
    client.get("/api/webhooks/w1", headers=h)
...
def test_checklists_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "cl1"}])
    h = auth_headers
    client.get("/api/checklists", headers=h)
    client.get("/api/checklists/cl1", headers=h)
...
def test_tax_rates_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "tr1"}])
    h = auth_headers
    client.get("/api/tax-rates", headers=h)
    client.get("/api/tax-rates/tr1", headers=h)
...
def test_users_full(client, auth_headers, configure_stdb):
    ...
    client.get("/api/users/u1", headers=h)
    client.post("/api/users", headers=h, json={"name": "New", "email": "n@b.com"})
    client.put(
        "/api/users/u1", headers=h, json={"name": "Updated", "email": "u@b.com", "role": "admin", "active": True}
    )
...
def test_custom_fields_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "cf1"}])
    h = auth_headers
    client.get("/api/custom-fields", headers=h)
    client.get("/api/custom-fields/cf1", headers=h)
...
def test_customers_full(client, auth_headers, configure_stdb):
    ...
    client.get("/api/customers/c1", headers=h)
    client.post(
        "/api/customers", headers=h, json={"first_name": "J", "last_name": "D", "email": "j@d.com", "phone": "555"}
    )
    client.put(
        "/api/customers/c1", headers=h, json={"first_name": "J", "last_name": "S", "email": "j@s.com", "phone": ""}
    )
...
def test_report_schedules_full(client, auth_headers, configure_stdb):
    ...
    cfg([{"id": "rs1"}])
    h = auth_headers
    client.get("/api/report-schedules", headers=h)
    client.get("/api/report-schedules/rs1", headers=h)
    client.post(
        "/api/report-schedules", headers=h, json={"name": "Daily", "schedule": "0 9 * * *", "report": "summary"}
    )
