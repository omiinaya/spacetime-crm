...
class TestPOS:
    def test_list_sales(self, client, monkeypatch):
    ...
    def test_get_sale(self, client, monkeypatch):
    ...
    def test_add_item(self, client, monkeypatch):
