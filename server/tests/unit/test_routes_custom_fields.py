...
class TestCustomFields:
    def test_list_definitions(self, client, monkeypatch) -> None:
    ...
    def test_create_definition(self, client, monkeypatch) -> None:
    ...
    def test_update_definition(self, client, monkeypatch) -> None:
        mock_call = AsyncMock(return_value={})
        monkeypatch.setattr("routes.custom_fields._call", mock_call)
        monkeypatch.setattr("routes.custom_fields._log_audit", AsyncMock())
        body = {
    ...
    def test_delete_definition(self, client, monkeypatch) -> None:
        mock_call = AsyncMock(return_value={})
        monkeypatch.setattr("routes.custom_fields._call", mock_call)
        monkeypatch.setattr("routes.custom_fields._log_audit", AsyncMock())
    ...
    def test_get_field_values(self, client, monkeypatch) -> None:
    ...
    def test_set_field_values(self, client, monkeypatch) -> None:
        mock_call = AsyncMock(return_value={})
        monkeypatch.setattr("routes.custom_fields._call", mock_call)
