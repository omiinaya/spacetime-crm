...
class TestSettings:
    def test_get_mail_settings(self, client, monkeypatch):
    ...
    def test_update_mail_settings(self, client, monkeypatch):
    ...
    def test_test_mail(self, client, monkeypatch):
    ...
    def test_get_sms_settings(self, client, monkeypatch):
    ...
    def test_update_sms_settings(self, client, monkeypatch):
    ...
    def test_get_business_hours(self, client, monkeypatch):
    ...
    def test_update_business_hours(self, client, monkeypatch):
