...
class TestUsers:
    def test_list_users(self, client, monkeypatch) -> None:
    ...
    def test_get_user_settings(self, client, monkeypatch) -> None:
    ...
    def test_get_user_settings_not_found(self, client, monkeypatch) -> None:
    ...
    def test_update_user_settings(self, client, monkeypatch) -> None:
        mock_call = AsyncMock(return_value={})
        monkeypatch.setattr("routes.users._call", mock_call)
        monkeypatch.setattr("routes.users._log_audit", AsyncMock())
