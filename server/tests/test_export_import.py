...
class TestExport:
    def test_export_customers(self, test_admin_headers: dict) -> None:
    ...
    def test_export_invalid_entity(self, test_admin_headers: dict) -> None:
        resp = httpx.get(f"{SERVER_URL}/api/export/nonexistent", headers=test_admin_headers, timeout=10)
        assert resp.status_code == 400

    def test_export_tickets(self, test_admin_headers: dict) -> None:
        resp = httpx.get(f"{SERVER_URL}/api/export/tickets", headers=test_admin_headers, timeout=10)
        assert resp.status_code == 200


class TestImport:
    def test_import_customers_without_id(self, test_admin_headers: dict, session_suffix: str) -> None:
    ...
    def test_import_customers_missing_first_name(self, test_admin_headers: dict) -> None:
    ...
    def test_import_products(self, test_admin_headers: dict, session_suffix: str) -> None:
        suf = unique_suffix()
    ...
    def test_import_products_missing_name(self, test_admin_headers: dict) -> None:
...
class TestExportImportErrors:
    def test_export_unauthorized(self, client: httpx.Client) -> None:
        resp = client.get("/api/export/customers", timeout=10)
        assert resp.status_code in (401, 403)

    def test_import_unauthorized(self, client: httpx.Client) -> None:
