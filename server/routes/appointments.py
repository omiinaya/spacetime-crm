...
async def list_recurring_series(user: Annotated[dict, Depends(require_role("admin", "tech", "front_desk"))]):
...
async def get_appointments_due_soon(user: Annotated[dict, Depends(require_role("admin", "tech", "front_desk"))]):
