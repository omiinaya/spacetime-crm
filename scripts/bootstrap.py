...
r = C.post(f"/v1/database/{STDB_DB}/call/create_user", json=["admin", "admin@crm.local", "admin"])
...
pw = os.environ.get("CRM_ADMIN_PW", "change-me-in-production")
print(f"\n✅ Bootstrap complete — admin@crm.local / {pw}")
