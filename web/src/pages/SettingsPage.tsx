...
import { Settings, Plus, User as UserIcon, Mail, CheckCircle, XCircle, Loader2, Percent, Webhook, Globe, Trash2, Play, Phone, Shield, ShieldAlert, Smartphone, Clock, Sun, Moon, Palette } from "lucide-react";
...
function UserPreferencesSection() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (res.settings) {
        setForm({ theme: res.settings.theme, default_ticket_status: res.settings.default_ticket_status });
      }
      return res;
    },
  });
