    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-muted-foreground">
          Set your shop's operating hours. These determine when appointments can be scheduled and
          which time slots are available in the calendar.
        </p>
        ...
        <div className="border-t pt-3">
          <p className="text-xs text-muted-foreground">
            <strong>How this is used:</strong> The appointment scheduler will only offer time slots
            within operating hours. Days marked as closed won't appear in the date picker. Future
            features will add lunch breaks and holiday closures.
          </p>
        </div>
      </CardContent>
    </Card>
