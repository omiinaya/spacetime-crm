...
export default function PurchaseOrdersPage() {
	...
	const receiveMutation = useMutation({
		mutationFn: () => {
			if (!selectedPo || !poDetail?.line_items)
				throw new Error("No PO or items");
							...
							<div className="flex gap-2 mb-4 flex-wrap">
								...
								{(poDetail.status === "sent" ||
									...
									<Button
										...
										onClick={() =>
											setReceiveMode(
												receiveMode === poDetail.id ? null : poDetail.id,
											)
										}
									>
										<PackageCheck className="h-3.5 w-3.5 mr-1.5" />
							...
							<Card className="mb-4">
								<CardContent className="pt-4 space-y-1 text-sm">
									<div className="flex justify-between">
										...
										<span>
											{poDetail.currency || "USD"}{" "}
											{poDetail.subtotal.toFixed(2)}
										</span>
										{poDetail.shipping_cost > 0 && (
											<div className="flex justify-between text-muted-foreground">
												...
												<span>
													{poDetail.currency || "USD"}{" "}
													{poDetail.shipping_cost.toFixed(2)}
												</span>
											</div>
										)}
									</div>
								...
								<Card className="border-green-500/30 bg-green-500/5">
									<CardContent className="pt-4">
										...
										<p className="text-xs text-muted-foreground mb-3">
											Stock levels will be updated and inventory adjustments
											created.
										</p>
										<div className="flex gap-2">
