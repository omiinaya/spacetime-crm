...
export default function EstimatesPage() {
	...
	const hasData =
		data && data.estimates && data.estimates.length > 0 && data.total > 0;
					...
					<div className="space-y-4">
						<Card>
							<CardHeader>
								...
								<div className="flex gap-2 flex-wrap">
									<Button
										...
										onClick={() =>
											window.open(
												`/api/estimates/${selectedEst.id}/pdf`,
												"_blank",
											)
										}
									>
									...
									{selectedEst.status === "approved" && (
										...
										>
											<FileCheck className="h-3.5 w-3.5 mr-1" /> Convert to
											Invoice
										</Button>
									)}
								</div>
							...
							<CardContent className="space-y-3">
								...
								{selectedEst.tax_rate > 0 && (
									<p className="text-sm text-muted-foreground">
										Tax Rate: {selectedEst.tax_rate}%
									</p>
								)}
								{selectedEst.invoice_id && (
									<a
										href={"/invoices/" + selectedEst.invoice_id}
