...
import { Calendar, CalendarClock, ChevronLeft, ChevronRight, Clock, User } from 'lucide-react';
            ...
            <div className="space-y-4">
              {Object.entries(byDay).length === 0 ? (
                <div className="text-center py-16 text-muted-foreground">
                  ...
                  <p>No appointments for {selectedGroup?.user_name} this month.</p>
                </div>
              ) : (
              ...
              <Button variant="outline" size="sm" onClick={() => setSelectedTech('')}>
                ← Back to all techs
              </Button>
            </div>
          )}
