...
import type { Invoice, InvoiceLineItem, InvoiceSummary, RecurringInvoiceRule } from './types';
...
export const invoices = {
  ...
  emailQueueStatus: () => apiFetch<{ sends: any[]; count: number }>('/invoices/email-queue-status'),
};
