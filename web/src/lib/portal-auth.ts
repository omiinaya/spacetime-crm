...
export const portalApi = {
  ...
  estimates: {
    list: () => portalApiFetch<{ estimates: PortalEstimate[] }>('/portal/estimates'),
    get: (id: string) => portalApiFetch<{ estimate: PortalEstimate }>(`/portal/estimates/${id}`),
    setStatus: (id: string, status: 'approved' | 'declined') =>
      portalApiFetch<{ ok: boolean }>(`/portal/estimates/${id}/status`, {
        method: 'POST',
